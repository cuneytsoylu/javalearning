...
int sayac=0;//her bir ogrencinin dogru cevabini sayacagi icin,sayac buraya konur
            for (int j = 0; j < answers[i].length ; j++) {//her ogrencinin cevaplarına bakar j->ogrenci cevaplarina bakar
                if (answers[i][j]==keys[j]) { //cevap anahtari ile ogrenci cevaplari karssilastiriliyor
sayac++;
                }
            }
