...
public class C02_PassByValue {
    public static void main(String[] args) {
        /*
        Bİrden fazla element iceren array ve arrayList gibi yapilarda da
        passByValue gecerlidir

        eger method da array veya list in kendisi degistirilirse passByValue
        ozelligi sebebiyle Java degisen degeri degil
         array veya listin orijinal degerini alir

         Ancak array veya l,st degistirilmeden
         sadece icindeki elemanlar degistirilirse
        Java obje degismedigi icin(referans ayni)
        ayni array veya listi bize dondurur ancak icindeki elementler
        degismis olacaktir
         */
        /*
