...
public class C01_ClassLevelVariables {
    /*
    class icerisinden heryerden kullanmak istediginiz variable lari
    ...
    public static void main(String[] args) {
        ...
        /* System.out.println(instSayi);
         ...
         dolayisiyla obje olustutrursaniz instance variableleri heryerden kullanabilirsiniz
...
obje2.instSayi=25;
        System.out.println("obje1 degistikten sonra: "+obje2.instSayi);//25
    ...
    public static void staticMethod(){
        ...
        bir method un icerisinde olusturulan variable,sadece
         o method un icinden kullanilabilir
         (Local variables)
 ...
 */
    ...
    public void staticOlmayanMethod(){
        ...
        System.out.println(instSayi);
        /*
        instance variablel lar class icerisindeki
