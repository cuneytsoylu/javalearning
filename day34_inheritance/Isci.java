...
public class Isci extends Personel {
    ...
    Java da ise child class lar ozelliklerini inherit etmek istedikleri class i kendilerine
    parent edinirler.

    mesela isci class i ni olusturunca nelere ihtiyaci var
    diye dusunursek personel classini daki t
    um variable ve method lara ihtiyaci oldugunu gorebiliriz
    bu durumda yeniden o variable ve methodlari olusturmak yerine
    Personel cclassi ni kendimize parent ediniriz


Bir class i parent edinmek icin extends keyword kullanmaliyiz

bir class baska bir class i parent edindiginde
1-parent class daki tum ozellkiklere(variable+method)otomatik olarak sahip olur
