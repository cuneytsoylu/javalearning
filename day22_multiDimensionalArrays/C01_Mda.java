...
public class C01_Mda {
    public static void main(String[] args) {
        ...
        her non-primitive data direk yazdirilmamalidir
        ...
        1-elemanlari direk yazabiliriz
         int [][] sayilar={{1,2,4,5},{3,4}};
         2-outer ve inner array lerin uzunluklari belirterek olusturabiliriz
...
eger inner          arraylaeri farkli uzunlukta olusturmak istiyorsaniz
